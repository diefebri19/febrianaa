...
def send_about(message):
    ...
    with open('template_text/about.txt', mode='r', encoding='utf-8') as f:
        ...
        about = temp.substitute(
            STUDENT_NAME = "BERNIKE_FEBRIANA_SAMOSIR",
            BATCH_ACADEMY = "QOPPA NIGHT ONLINE COPPA",
            GITHUB_REPO_LINK = "https://github.com/diefebri19/Febriana"
        )
...
#     # TO DO: chat_id (SAME AS CHECKPOINT 1)
     ...
     if selected_campaign_id in unique_campaign:
         ...
         df_campaign = df[df['campaign_id'] == selected_campaign_id]
         df_plot = df_plot = df_campaign.groupby('age').agg({'spent' :'sum','approved_conversion' : 'sum',})
...
#     # TO DO: emoji
     with open('template_text/default.txt', mode='r', encoding='utf-8') as f:
         ...
         default = temp.substitute(EMOJI=emoji.emojize(":man_bowing_medium-light_skin_tone:"))
